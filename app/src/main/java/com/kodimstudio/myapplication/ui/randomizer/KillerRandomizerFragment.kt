...
import com.kodimstudio.myapplication.databinding.FragmentKillerRandomizerBinding
import com.kodimstudio.myapplication.model.Character


class KillerRandomizerFragment : Fragment() {
    private lateinit var binding: FragmentKillerRandomizerBinding
    private val perks = Data.killerPerks
    private val characters = Data.killerCharacters
    ...
    override fun onCreateView(
        ...
        binding = FragmentKillerRandomizerBinding.inflate(inflater, container, false)
        ...
        if (sp.getBoolean("saveChoice", true)) {
            val selectedCharactersIndexes = sp.getStringSet("selectedCharactersIndexes", null)
            val excludedPerksIndexes = sp.getStringSet("excludedPerksIndexes", null)
        ...
        binding.helpButton.setOnClickListener {
            with(Dialog(requireContext())) {
                setContentView(R.layout.dialog_killer_randomizer_help)
        ...
        val iconPower = dialog.findViewById<ImageView>(R.id.item_icon)
        ...
        randomizeButton.setOnClickListener {
            ...
            iconPower.setImageResource(randomizedCharacter.powerImageResId)

            val shuffledAddons = randomizedCharacter.powerAddons.shuffled()
            iconAddon1.setImageResource(shuffledAddons[0])
            iconAddon2.setImageResource(shuffledAddons[1])
            ...
            if (sp.getBoolean("saveChoice", true)) {
                sp.edit()
                    .putStringSet("selectedCharactersIndexes", selectedCharactersIndexes.toMutableSet())
                    .putStringSet("excludedPerksIndexes", excludedPerksIndexes.toMutableSet())
                    .apply()
            }
        }
