...
import com.kodimstudio.myapplication.databinding.FragmentChallengesListSurvBinding
import com.kodimstudio.myapplication.ui.MainActivity

class ChallengesListSurvFragment : Fragment() {
    private lateinit var binding: FragmentChallengesListSurvBinding

    override fun onCreateView(
        inflater: LayoutInflater,
        container: ViewGroup?, savedInstanceState: Bundle?
    ): View {
        binding = FragmentChallengesListSurvBinding.inflate(inflater, container, false)
        ...
        val challenges = dao.getAll(type = "survivor")
